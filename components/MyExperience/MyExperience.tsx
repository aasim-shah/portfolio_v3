        ...
        >
          {myExperience?.map((exp, index) => (
            ...
            >
              ...
              <div className="border-dark-gray-3 rounded-xl bg-darkest-gray flex flex-none flex-col flex-nowrap gap-1 h-min justify-start overflow-visible p-4 relative w-full">
