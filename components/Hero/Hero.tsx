      ...
      <section className="flex flex-col lg:flex-row items-center flex-none flex-nowrap gap-[20px] h-min justify-start overflow-visible p-0 relative w-full ">
        ...
        <div className="flex flex-col items-start gap-2 p-0 relative w-full h-auto">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-[16px] text-light-gray-2 font-medium leading-[150%] mb-4"
          >
            I craft high-performance web apps, seamless APIs, and dynamic
            full-stack solutions—turning ideas into reality!
          </motion.p>
          ...
          >
            ...
            {/* <Button position='left' icon={<Calendar1 size={18} />} 
                        title='Schedule Call' /> */}
            <ScheduleButton icon={calendarIcon} label="Schedule Meeting" />
          </motion.div>
        </div>
      </section>
      {/* middle  */}
